...
wordArray.forEach((word, index) => {
  const wordObj = {
    number : index + 1,
    word : word,
    pinyin : pinyin(word)[0][0]
  }

  WordModel.create(wordObj).then((word) => {
...
const chapters = [
  { name: '1-50',     number: 1 },
  { name: '51-100',   number: 2 },
  { name: '101-150',  number: 3 },
  { name: '151-200',  number: 4 },
  { name: '201-250',  number: 5 },
  { name: '251-300',  number: 6 },
  { name: '301-350',  number: 7 },
  { name: '351-400',  number: 8 },
  { name: '401-450',  number: 9 },
  { name: '451-500',  number: 10 },
  { name: '501-550',  number: 11 },
  { name: '551-600',  number: 12 },
  { name: '601-650',  number: 13 },
  { name: '651-700',  number: 14 },
  { name: '701-750',  number: 15 },
  { name: '751-800',  number: 16 },
  { name: '801-850',  number: 17 },
  { name: '851-900',  number: 18 },
  { name: '901-950',  number: 19 },
  { name: '951-1000', number: 20 }
]

chapters.forEach((chapter, index) => {
  ChapterModel.create(chapter).then((chapter) => {
